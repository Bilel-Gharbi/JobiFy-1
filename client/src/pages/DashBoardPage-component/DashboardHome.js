...
const DashboardHome = ({ setElementToRender, applications, jobs }) => {
  return (
    <>
      <div
        ...
        <div className="kt-widget17">
          <div className="kt-widget17__stats">
            <div className="kt-widget17__items">
              <div
                className="kt-widget17__item"
                onClick={() => setElementToRender("Create job offer")}
              >
                ...
                <span className="kt-widget17__subtitle">Create Job </span>
                <span className="kt-widget17__desc">15 Job</span>
              </div>
              <div
                className="kt-widget17__item"
                onClick={() => setElementToRender("jobOfferList")}
              >
                <span className="kt-widget17__icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="kt-widget17__subtitle">Job Offer</span>
            ...
            <div className="kt-widget17__items">
              <div
                className="kt-widget17__item"
                onClick={() => setElementToRender("Candidate")}
              >
                <span className="kt-widget17__icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="kt-widget17__subtitle">Job Applications</span>
                <span className="kt-widget17__desc">
              ...
              <div className="kt-widget17__item">
                ...
                <span className="kt-widget17__subtitle">Views</span>
                <span className="kt-widget17__desc">34 views</span>
              </div>
            </div>
          </div>
        </div>
...
const mapStateToProps = (state) => {
  return {
    ...
    jobs: state.companyProfile.jobOffers,
  };
};
